  ...
  return (
    ...
    >
      <div className="modal-content">
        <ModalHeader toggle={toggle}>Toys Details</ModalHeader>
        <ModalBody>
          <p className="mb-2">
            Status: <span className="text-primary">AVAILABLE</span>
          </p>
          <p className="mb-4">
            Toy Name: <span className="text-primary">Neal Matthews</span>
          </p>
