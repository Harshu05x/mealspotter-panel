...
function NewRegistrations() {
    ...
    //meta title
    document.title = "New Registrations";
    ...
    useEffect(() => {
        dispatch(onGetCustomers(true,pageNumber, limit, query));
    ...
    const onClickDelete = (customerData) => {
    ...
    const exportToCSVButtonClicked = async () => {
        try {
            const res = await get(`customers?enquiry=${true}&query=${query}&csvTrue=${true}`,);
        ...
        <React.Fragment>
            ...
            <div className="page-content">
                <div className="container-fluid">
                    <Breadcrumbs title="Home" breadcrumbItem="New Registrations" />
                    <Row>
                        <Col xs="12">
                            <Card>
                                <CardBody>
